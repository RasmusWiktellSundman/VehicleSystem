...
public abstract class PrivateVehicle extends Vehicle {
	public PrivateVehicle(Customer owner, String registrationNumber, int maximumPassengers, int wheels, Calendar constructionDate, Calendar boughtDate, double purchasePrice) {
